...
func TestInitialElection2A(t *testing.T) {
	...
	if term1 != term2 {
		logger.Warnf("warning: term changed even though there were no failures")
	}
...
func TestManyElections2A(t *testing.T) {
	...
	for ii := 1; ii < iters; ii++ {
		...
		cfg.disconnect(i2)
		cfg.disconnect(i3)
		logger.Debugf("disconnect: %d %d %d\n", i1, i2, i3)
